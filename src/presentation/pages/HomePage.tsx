...
export function HomePage() {
  ...
  function addTransaction(event: FormEvent<HTMLFormElement>) {
    ...
    addStoredTransaction({ name, amount, type: transactionType, category: String(form.get('category') ?? 'Outros') })
